...
const Footer = () => {
  return (
    <div className="bg-[#bed2e5] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        <div className="max-w-80">
          <img
            src={assets.logo}
            alt="logo"
            className="mb-4 h-20 md:h-20 invert"
          />
          <p className="text-sm">
            We connect you with handpicked hotels at the world’s most
            sought-after destinations. Find and book the perfect place to
            stay—designed around your dream experience.
          </p>
